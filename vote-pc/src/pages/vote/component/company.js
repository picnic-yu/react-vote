            ...
            <div className='company'>
                ...
                <div className="item_wrap">
                    <div className="content_left">
                        <img  src='http://new.szdtb.com/image/company.png' />
                    </div>
                ...
                <h3 style={{textAlign:'center',fontSize:'30px',padding:'10px 0'}}>艾知星—数字化口腔虚拟教学评估系统</h3>
                <div className="item_wrap">
                    ...
                    <div className="content_left">
                        <img style={{height: '100%', width: '100%'} } src='http://new.szdtb.com/image/equipment.png' />
                    </div>
                </div>
